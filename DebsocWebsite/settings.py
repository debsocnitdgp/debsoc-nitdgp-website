...
SECRET_KEY='Wonttellyou'
DEBUG=1
DB_NAME='debcossite'
DB_USER='apurvajpaul'
DB_PASSWORD='Ddcx#1707'
API_SEC=AUTH_PASSWORD_VALIDATORS
API_KEY='adfasdf'
CLOUDINARY_URL='cloudinary://NiceUrlHere'
...
#SECRET_KEY='3_8=yc-c#r!mxh*&s=c-%sd8l0^_*%t@$xgn9yh4@=7_8r=g_6'
